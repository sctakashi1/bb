...
btn_purchase.add(
    types.InlineKeyboardButton(text='1/5', callback_data='buy_number_menu'),
    types.InlineKeyboardButton(text='2/5', callback_data='buy_number_menu2'),
    types.InlineKeyboardButton(text='3/5', callback_data='buy_number_menu3'),
    types.InlineKeyboardButton(text='4/5', callback_data='buy_number_menu4'),
    types.InlineKeyboardButton(text='5/5', callback_data='buy_number_menu5'),
    types.InlineKeyboardButton(text='Избранное', callback_data='byy'),
